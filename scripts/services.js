...
homeServices.service('homeService', ['$http', 'DHIS2URL', function ($http, DHIS2URL) {
    ...
    home.uploadDocument = function (file) {
        ...
        return $http({
            ...
            data: file,
            url: url
        }).then(handleSuccess, handleError("Error storing file"));
    }
    ...
    home.addExternalLink = function (links, newLink) {
        ...
        return $http({
            ...
            data: externalinks,
            url: url
        }).then(handleSuccess, handleError("Error storing external links"));
    }
    ...
    home.updateExternalLink = function (links) {
        ...
        return $http({
            ...
            data: externalinks,
            url: url
        }).then(handleSuccess, handleError("Error  updating external links"));
    }
    ...
    home.hideDocument = function (documentId) {
        ...
        return $http({
            ...
            data: documents,
            url: url
        }).then(handleSuccess, handleError("Error hiding documents"));
    }
    ...
    home.showDocument = function (documentId) {
        ...
        return $http({
            ...
            data: documents,
            url: url
        }).then(handleSuccess, handleError("Error sho documents"));
    }
    ...
    home.removeDocument = function (charts) {
        ...
        return $http({
            ...
            data: documents,
            url: url
        }).then(handleSuccess, handleError("Error remove documents"));
    }
    ...
    home.addTab = function (modifiedTabs) {
        ...
        return $http({
            ...
            data: modifiedTabs,
            url: url
        }).then(handleSuccess, handleError("Error storing new tabs"));
    }
    home.updateTab = function (modifiedTabs) {
        ...
        return $http({
            ...
            data: modifiedTabs,
            url: url
        }).then(handleSuccess, handleError("Error storing update tabs"));
    }
    ...
    home.addTabContent = function (tabContents) {
        ...
        return $http({
            ...
            data: tabContents,
            url: url
        }).then(handleSuccess, handleError("Error storing tab contents"));
    }
    ...
    home.updateTabContent = function (tabContents) {
        ...
        return $http({
            ...
            data: tabContents,
            url: url
        }).then(handleSuccess, handleError("Error updating tab contents"));
    }
    ...
    home.getDataDimension = function (analytics, dataArray) {
        if (!analytics.metaData){return false}
        var dx = analytics.metaData.dx?analytics.metaData:null;
    ...
    home.addInformations = function (dataArray) {
        ...
        return $http({
            ...
            data: dataArray,
            url: url
        }).then(handleSuccess, handleError("Error storing adding information sharing"));
    ...
    home.loggedUser = function (passedUrl) {
...
homeServices.service('utilityService', function () {
    ...
    utilityService.formatAnalysis = function (reportTable) {
        var favourites = [{name: 'Agriculture', indicators: []}, {name: 'Livestock', indicators: []}, {
            name: 'Fishery',
            indicators: []
        }, {name: 'Trade', indicators: []}, {name: 'General Information', indicators: []}];
